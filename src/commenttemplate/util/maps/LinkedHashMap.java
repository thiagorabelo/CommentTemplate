...
package commenttemplate.util.maps;

import java.util.function.Consumer;
import java.util.function.BiConsumer;
import java.util.function.BiFunction;
import java.io.IOException;
import static commenttemplate.util.maps.HashMap.hash;
import java.util.*;
    ...
    implements Map<K,V>
{
    ...
    HashMap.TreeNode<K,V> replacementTreeNode(HashMap.Node<K,V> p, HashMap.Node<K,V> next) {
        LinkedHashMap.Entry<K,V> q = (LinkedHashMap.Entry<K,V>)p;
        HashMap.TreeNode<K,V> t = new HashMap.TreeNode<K,V>(q.hash, q.key, q.value, next);
        transferLinks(q, t);
        return t;
    }
